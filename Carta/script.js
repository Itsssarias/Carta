$(document).ready(function(){
    $('.valentines-day').click(function(){
        ...
        $('.envelope').fadeOut(800, function() {
            ...
            // Hacer visible la carta con una animación de aparición
            $('#card').css({'visibility':'visible', 'opacity': 0});
            $('#card').animate({'opacity': 1}, 1000); // Animación de aparición sin ondulación
        });
    });
});
...
(function(w,d,e,u,f,l,n){
    ...
    l.async=1,l.src=u,n=d.getElementsByTagName(e)[0],n.parentNode.insertBefore(l,n);
